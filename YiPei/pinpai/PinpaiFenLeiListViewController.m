//
//  PinpaiFenLeiListViewController.m
//  YiPei
//
...
@interface PinpaiFenLeiListViewController ()
@property(nonatomic,strong) IBOutlet UINavigationView * headNav;
@end

@implementation PinpaiFenLeiListViewController
...
-(IBAction)filterClick:(id)sender{
    PinPaiGuoLvViewController * guolvView = [[PinPaiGuoLvViewController alloc] init];
